...
<head>
    ...
    <meta property="fb:app_id" content="171482644955699" />
    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16">
                    <a class="hover:text-gray-300" href="{{route('movies.index')}}">
                        Movies
                    </a>
                </li>
                <li class="md:ml-6">
                    <a class="hover:text-gray-300" href="{{route('tv.index')}}">
                        TV Shows
                    </a>
                </li>
                <li class="md:ml-6">
                    <a class="hover:text-gray-300" href="{{ route('actors.index') }}">
                        Actors
                    </a>
                </li>
            </ul>
